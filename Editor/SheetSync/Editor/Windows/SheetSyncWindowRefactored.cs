...
namespace SheetSync.Editor.Windows
{
    ...
    /// </summary>
    public class SheetSyncWindowRefactored : EditorWindow
    {
        ...
        /// </summary>
        [MenuItem("SheetSync/Open SheetSync (Refactored)", false, 1)]
        public static void OpenWindow()
        {
            GetWindow<SheetSyncWindowRefactored>(false, "Sheet Sync", true).Show();
        }
